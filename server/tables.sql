USE LIHI;
CREATE TABLE IF NOT EXISTS VILLAGES (VID INT PRIMARY KEY auto_increment, NAME VARCHAR(50) NOT NULL);
CREATE TABLE IF NOT EXISTS PERMISSIONS (ROLE_ID INT PRIMARY KEY auto_increment, DESCRIPTION VARCHAR(255) NOT NULL);
CREATE TABLE IF NOT EXISTS PEOPLE (PID INT PRIMARY KEY auto_increment, NAME VARCHAR(50) NOT NULL, ROLE_ID INT NOT NULL, VID INT NOT NULL, CONSTRAINT FK_Permission FOREIGN KEY (ROLE_ID) REFERENCES PERMISSIONS(ROLE_ID), CONSTRAINT FK_Village FOREIGN KEY (VID) REFERENCES VILLAGES(VID));
...
INSERT INTO PEOPLE (NAME, ROLE_ID, VID) VALUES ("Jennifer", 1, 1), ("Sam", 2, 2);
